...
#define UTBL_COL_COUNT (1<<HIGH_INDEX_BIT)
	...
	typedef struct {
		...
		void        (*get_uni_name_from_ext_entry)(struct super_block *sb, CHAIN_T *p_dir, INT32 entry, UINT16 *uniname, INT32 *faulty_entry);
...
/* exfat Exportfs operations */
struct fid;

extern struct dentry *exfat_fh_to_dentry(struct super_block *sb, struct fid *fid,
                                       int fh_len, int fh_type);
extern struct dentry *exfat_fh_to_parent(struct super_block *sb, struct fid *fid,
                                       int fh_len, int fh_type);
#endif /* _EXFAT_H */
