...
struct _ntfs_inode {
	...
	FILE_ATTR_FLAGS flag;
	unsigned long mft_no;	/* Number of the mft record / inode. */
	u16 seq_no;		/* Sequence number of the mft record. */
	atomic_t count;		/* Inode reference count for book keeping. */
	atomic_t map_count;  /*map count*/
...
extern int __ntfs_test_real_inode(ntfs_inode *ni, ATTR_TYPE type,
...
extern int ntfs_getattr(struct vfsmount *mnt, struct dentry *dentry,
		  struct kstat *stat);
...
extern int ntfs_inode_detach_all_extents(ntfs_inode *ni);
extern int ntfs_read_locked_attr_inode(struct inode *base_vi, struct inode *vi);
...
extern int ntfs_inode_free_space(ntfs_inode *ni, MFT_RECORD *m, int size);
extern int ntfs_inode_add_attrlist(ntfs_inode *ni);
extern int ntfs_generic_ioctl(struct inode *inode, struct file *filp,
