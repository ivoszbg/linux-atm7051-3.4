...
extern MFT_RECORD *map_mft_record_lock(ntfs_inode *ni);
extern void unmap_mft_record_unlock(ntfs_inode *ni);
...
extern int ntfs_mft_record_free(ntfs_inode *ni, MFT_RECORD *m);
