...
// 20121229
// FIXME: to avoid unknown undefined instruction execption when write debug register 
// from S2 state occasionally.
//
// we have only a single powerdomain for debug and core
// so there is nonsense to reset debug register again.
//
