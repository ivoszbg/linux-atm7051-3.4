...
{	
	__u32 xml_buf_start;	
	__u32 xml_buf_len;
	__u32 bin_cfg_xml_buf_start;	
	__u32 bin_cfg_xml_buf_len;	
};
...
struct tag {
	...
	union {
		...
		struct tag_xml	xml;
		struct tag_pinctrl pinctrl;
		struct tag_dvfslevel dvfslevel;
		struct tag_board_opt board_opt;
		struct tag_pmem_info pmem_info;
		struct tag_boot_dev boot_dev;
        struct tag_boot_afinfo afinfo;
