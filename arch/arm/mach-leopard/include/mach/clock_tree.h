...
#define SICLK_SEL_MASK    (0x1<<4)
#define SICLK_DIV_MASK    (0xf)
...
#define GPU_CORECLK_SEL_MASK     (0x3<<4)
#define GPU_CORECLK_DIV_MASK     (0x7)
#define GPU_MEMCLK_SEL_MASK      (0x3<<20)
#define GPU_MEMCLK_DIV_MASK      (0x7<<16)
#define GPU_SYSCLK_SEL_MASK      (0x3<<28)
#define GPU_SYSCLK_DIV_MASK      (0x7<<24)

#define SDCLK_SEL_MASK    (0x3<<9)  
#define SDCLK_DIV_MASK    0x1f
#define SD_NIC_CLK_DIV_MASK  (0x3<<16)
...
#define SENSOROUTCLK_SEL_MASK   (0x1<<4)
#define SENSOROUTCLK_DIV_MASK   0xf

/*ÐÂÔö*/
#define THERMALCLK_DIV_MASK    (0xf<<8)
#define LEAKAGECLK_DIV_MASK    (0xf<<4)
#define SPEEDCLK_DIV_MASK    (0xf)
#endif