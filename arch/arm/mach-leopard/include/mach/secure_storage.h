...
/* provider interface */
extern int asoc_register_secure_storage(struct secure_storage *ss);
extern int asoc_unregister_secure_storage(struct secure_storage *ss);

/* user interface*/
extern int asoc_read_secure_storage_data(int type, char * buf, int size);
extern int asoc_write_secure_storage_data(int type, char * buf, int size);
