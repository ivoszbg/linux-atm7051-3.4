 ...
 */
#define ATC260X_ACCESS_MODE_NORMAL      (0)     /* access by standard SPI driver interface */
#define ATC260X_ACCESS_MODE_DIRECT      (1)     /* access SPI controller directly */
...
#define ATC2603C_IRQ_POWERIN              (10)
...
#define WAKEUP_SRC_WALL_OUT            (1 << 13)  /* 2603c */
#define WAKEUP_SRC_VBUS_OUT            (1 << 14)  /* 2603c */
#define WAKEUP_SRC_ALL                  (0x7fff)
