			     ...
			     unsigned int flags)
{
	...
	ION_PRINT("%s: len %d align %d heap_id_mask %u flags %x\n", __func__,
				       ...
				       enum dma_data_direction dir)
{
	...
	ION_PRINT("%s: syncing for device %s\n", __func__,
...
static long ion_ioctl(struct file *filp, unsigned int cmd, unsigned long arg)
{
	...
	case ION_IOC_ALLOC:
	{
		...
		if (IS_ERR(data.handle)) {
			pr_err("error handle in ION_IOC_ALLOC: %d\n",  PTR_ERR(data.handle));
	...
	case ION_IOC_MAP:
	{
		...
		ION_PRINT("%s ION_IOC_SHARE/ION_IOC_MAP\n", __func__);
	...
	case ION_IOC_CLEAN_INV_CACHES:
	{
		...
		ION_PRINT("%s ION_IOC_CLEAN_CACHES/ION_IOC_INV_CACHES/ION_IOC_CLEAN_INV_CACHES\n", __func__);
