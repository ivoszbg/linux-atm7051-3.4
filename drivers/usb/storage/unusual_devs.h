...
UNUSUAL_DEV(  0x1b1c, 0x1ab5, 0x0200, 0x0200,
		...
		USB_SC_DEVICE, USB_PR_DEVICE, NULL,
		US_FL_INITIAL_READ10 ),
/* Patched by xiaoyj <xiaoyongjun@actions-semi.com>
 * fix the bug LAVA 210G Dongle offline from ppp 
 * needs the US_FL_IGNORE_RESIDUE flag to work properly.
 */		
UNUSUAL_DEV(  0x1c9e, 0x6003, 0x0000, 0x0000,
		"LAVA",
		"WM66E",
		USB_SC_DEVICE, USB_PR_DEVICE, usb_stor_lava_210g_init,
		0),		
...
//added by tangshaoqing <tangshaoqing@actions-semi.com>
UNUSUAL_DEV(  0x8564, 0x1000, 0x0100, 0x0100,
		"Unknown",
		"Unknown",
		USB_SC_DEVICE, USB_PR_DEVICE, NULL,
		US_FL_BULK_IGNORE_TAG ),
